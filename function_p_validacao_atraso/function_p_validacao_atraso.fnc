create or replace function icesp_aep_obter_regra_tempo (
    nr_seq_agenda_p agendacons.nr_sequencia%type,
    cd_agenda_p agenda.cd_agenda%type,
    ie_tipo_agenda_p number)
    
/*=============================================================
Sobre: FUNCTION utilizada para verificar assiduidade do cliente
---com relação ao horário da sua consulta, procedimento ou 
---tratamento. Retornando S caso confirmado ou N caso 
---não confirmado.
--------------------------------------------------------------
Parâmetros: 
    NR_SEQ_AGENDA_P: sequência do registro agendamento
    CD_AGENDA_P:  código da agenda
    IE_TIPO_AGENDA_P: tipo da agenda
        1 ou 3: AMB ou GERAIS
        2: PROCEDIMENTOS
        4: TRATAMENTO
==============================================================*/
...
is
    ...
    nr_tempo_antes_v number;
    nr_tempo_depois_v number;
    ie_ignorar_v varchar2(1);
